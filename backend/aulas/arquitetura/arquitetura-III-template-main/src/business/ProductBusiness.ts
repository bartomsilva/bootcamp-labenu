...
import { EditProductInputDTO, EditProductOutputDTO } from "../dtos/editProduct.dot"
import { GetProductInputDTO, GetProductOutputDTO } from "../dtos/getProduct.dto"
...
export class ProductBusiness {
  ...
  public getProducts = async (input: GetProductInputDTO):Promise<GetProductOutputDTO[]> => {
    ...
    const output:GetProductOutputDTO[] = products.map((product) => ({
      id: product.getId(),
