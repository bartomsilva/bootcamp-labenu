...
const posts: Post[] = [
  ...
  {
    autor: 'Lord Voldelive',
    texto: 'Avada Kedavra!'
  }
]

function buscarPostsPorAutor(posts:Post[], autorInformado?:string):Array<Post> {
  if (!autorInformado) return posts
...
console.log(buscarPostsPorAutor(posts, "Lord Voldelive"))
console.log("----------------------------------------")
